...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        dock_status->setMinimumSize(QSize(325, 494));
        ...
        verticalLayout_3->addWidget(load);

        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout_3->addItem(verticalSpacer);

        unload = new QPushButton(frame);
        unload->setObjectName(QString::fromUtf8("unload"));

        verticalLayout_3->addWidget(unload);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        load->setText(QApplication::translate("MainWindowDesign", "load", 0, QApplication::UnicodeUTF8));
        unload->setText(QApplication::translate("MainWindowDesign", "unload", 0, QApplication::UnicodeUTF8));
